 <nav class="navbar navbar-expand-lg bg-light text-uppercase fs-6 p-3 border-bottom align-items-center">
    <div class="container-fluid">
      <div class="row justify-content-between align-items-center w-100">
        ...
        <div class="col-auto">
          <a class="navbar-brand text-white" href="{{ asset('assets/style.css') }}/index.html">
            ...
            <div class="offcanvas-body">
              <ul class="navbar-nav justify-content-end flex-grow-1 gap-1 gap-md-5 pe-3">
                <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle active" href={{ asset('assets/style.css') }}"/#" id="dropdownHome" data-bs-toggle="dropdown"
                    aria-haspopup="true" aria-expanded="false">Home</a>
                  <ul class="dropdown-menu list-unstyled" aria-labelledby="dropdownHome">
                    <li>
                      <a href="{{ asset('assets/style.css') }}/index.html" class="dropdown-item item-anchor">Home Layout 1</a>
                    </li>
                    <li>
                      <a href="{{ asset('assets/style.css') }}/index.html" class="dropdown-item item-anchor">Home Layout 2 </a>
                    </li>
                    <li>
                      <a href="{{ asset('assets/style.css') }}/index.html" class="dropdown-item item-anchor">Home Layout 3 </a>
                    </li>
                    <li>
                      <a href="{{ asset('assets/style.css') }}/index.html" class="dropdown-item item-anchor">Home Layout 4 </a>
                    </li>
                  </ul>
                </li>
                <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle" href="{{ asset('assets/style.css') }}#" id="dropdownShop" data-bs-toggle="dropdown"
                    aria-haspopup="true" aria-expanded="false">Shop</a>
                  <ul class="dropdown-menu list-unstyled" aria-labelledby="dropdownShop">
                    <li>
                      <a href="{{ asset('assets/style.css') }}/index.html" class="dropdown-item item-anchor">Shop Sidebar </a>
                    </li>
                    <li>
                      <a href="{{ asset('assets/style.css') }}/index.html" class="dropdown-item item-anchor">Shop Three Column </a>
                    </li>
                    <li>
                      <a href="{{ asset('assets/style.css') }}/index.html" class="dropdown-item item-anchor">Shop Three Column Wide </a>
                    </li>
                    <li>
                      <a href="{{ asset('assets/style.css') }}/index.html" class="dropdown-item item-anchor">Shop Four Column </a>
                    </li>
                    <li>
                      <a href="{{ asset('assets/style.css') }}/index.html" class="dropdown-item item-anchor">Shop Four Column Wide </a>
                    </li>
                    <li>
                      <a href="{{ asset('assets/style.css') }}/index.html" class="dropdown-item item-anchor">Shop Six Column </a>
                    </li>
                    <li>
                      <a href="{{ asset('assets/style.css') }}/index.html" class="dropdown-item item-anchor">Shop Six Column Wide </a>
                    </li>
                    <li>
                      <a href="{{ asset('assets/style.css') }}/index.html" class="dropdown-item item-anchor">Single Product </a>
                    </li>
                    <li>
                      <a href="{{ asset('assets/style.css') }}/index.html" class="dropdown-item item-anchor">Single Product V2 </a>
                    </li>
                  </ul>
                </li>
                <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle" href="{{ asset('assets/style.css') }}#" id="dropdownBlog" data-bs-toggle="dropdown"
                    aria-haspopup="true" aria-expanded="false">Blog</a>
                  <ul class="dropdown-menu list-unstyled" aria-labelledby="dropdownBlog">
                    <li>
                      <a href="{{ asset('assets/style.css') }}/index.html" class="dropdown-item item-anchor">Blog Classic </a>
                    </li>
                    <li>
                      <a href="{{ asset('assets/style.css') }}/index.html" class="dropdown-item item-anchor">Blog Grid with Sidebar </a>
                    </li>
                    <li>
                      <a href="{{ asset('assets/style.css') }}/index.html" class="dropdown-item item-anchor">Blog Grid Four Column </a>
                    </li>
                    <li>
                      <a href="{{ asset('assets/style.css') }}/index.html" class="dropdown-item item-anchor">Blog No Sidebar </a>
                    </li>
                    <li>
                      <a href="{{ asset('assets/style.css') }}/index.html" class="dropdown-item item-anchor">Blog Right Sidebar </a>
                    </li>
                    <li>
                      <a href="{{ asset('assets/style.css') }}/index.html" class="dropdown-item item-anchor">Single Post </a>
                    </li>
                    <li>
                      <a href="{{ asset('assets/style.css') }}/index.html" class="dropdown-item item-anchor">Single Post No Sidebar </a>
                    </li>
                  </ul>
                </li>
                <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle" href="{{ asset('assets/style.css') }}#" id="dropdownPages" data-bs-toggle="dropdown"
                    aria-haspopup="true" aria-expanded="false">Pages</a>
                  <ul class="dropdown-menu list-unstyled" aria-labelledby="dropdownPages">
                    <li>
                      <a href="{{ asset('assets/style.css') }}/index.html" class="dropdown-item item-anchor">About </a>
                    </li>
                    <li>
                      <a href="{{ asset('assets/style.css') }}/index.html" class="dropdown-item item-anchor">Cart </a>
                    </li>
                    <li>
                      <a href="{{ asset('assets/style.css') }}/index.html" class="dropdown-item item-anchor">Checkout </a>
                    </li>
                    <li>
                      <a href="{{ asset('assets/style.css') }}/index.html" class="dropdown-item item-anchor">Coming Soon </a>
                    </li>
                    <li>
                      <a href="{{ asset('assets/style.css') }}/index.html" class="dropdown-item item-anchor">Contact </a>
                    </li>
                    <li>
                      <a href="{{ asset('assets/style.css') }}/index.html" class="dropdown-item item-anchor">Error Page </a>
                    </li>
                    <li>
                      <a href="{{ asset('assets/style.css') }}/index.html" class="dropdown-item item-anchor">FAQs </a>
                    </li>
                    <li>
                      <a href="{{ asset('assets/style.css') }}/index.html" class="dropdown-item item-anchor">My Account </a>
                    </li>
                    <li>
                      <a href="{{ asset('assets/style.css') }}/index.html" class="dropdown-item item-anchor">Order Tracking </a>
                    </li>
                    <li>
                      <a href="{{ asset('assets/style.css') }}/index.html" class="dropdown-item item-anchor">Wishlist </a>
                    </li>
                  </ul>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="{{ asset('assets/style.css') }}/index.html">Blog</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="{{ asset('assets/style.css') }}/index.html">Contact</a>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div class="col-3 col-lg-auto">
          <ul class="list-unstyled d-flex m-0">
            <li class="d-none d-lg-block">
              <a href="{{ asset('assets/style.css') }}/index.html" class="text-uppercase mx-3">Wishlist <span class="wishlist-count">(0)</span>
              </a>
            </li>
            <li class="d-none d-lg-block">
              <a href="{{ asset('assets/style.css') }}/index.html" class="text-uppercase mx-3" data-bs-toggle="offcanvas" data-bs-target="#offcanvasCart"
                aria-controls="offcanvasCart">Cart <span class="cart-count">(0)</span>
              </a>
            </li>
            <li class="d-lg-none">
              <a href="{{ asset('assets/style.css') }}/index.html" class="mx-2">
                <svg width="24" height="24" viewBox="0 0 24 24">
                  <use xlink:href="{{ asset('assets/style.css') }}#heart"></use>
                </svg>
              </a>
            </li>
            <li class="d-lg-none">
              <a href="{{ asset('assets/style.css') }}/index.html" class="mx-2" data-bs-toggle="offcanvas" data-bs-target="#offcanvasCart"
                aria-controls="offcanvasCart">
                <svg width="24" height="24" viewBox="0 0 24 24">
                  <use xlink:href="{{ asset('assets/style.css') }}#cart"></use>
                </svg>
              </a>
            </li>
            <li class="search-box" class="mx-2">
              <a href="{{ asset('assets/style.css') }}/index.html#search" class="search-button">
                <svg width="24" height="24" viewBox="0 0 24 24">
                  <use xlink:href="{{ asset('assets/style.css') }}#search"></use>
                </svg>
              </a>
            </li>
          </ul>
