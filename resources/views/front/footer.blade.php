        ...
        <div class="col-md-3 col-sm-6">
          <div class="footer-menu footer-menu-001">
            <div class="footer-intro mb-4">
              <a href="{{ url('/') }}">
                <img src="{{ asset('front/images/main-logo.png') }}" alt="logo">
              </a>
            </div>
        ...
        <div class="col-md-3 col-sm-6">
          <div class="footer-menu footer-menu-002">
            ...
            <ul class="menu-list list-unstyled text-uppercase border-animation-left fs-6">
              <li class="menu-item"><a href="{{ url('/') }}" class="item-anchor">Home</a></li>
              <li class="menu-item"><a href="#" class="item-anchor">About</a></li>
              <li class="menu-item"><a href="#" class="item-anchor">Services</a></li>
              <li class="menu-item"><a href="#" class="item-anchor">Single item</a></li>
        ...
        <div class="col-md-3 col-sm-6">
          <div class="footer-menu footer-menu-003">
            ...
            <ul class="menu-list list-unstyled text-uppercase border-animation-left fs-6">
              ...
              <li class="menu-item"><a href="#" class="item-anchor">Faqs</a></li>
            </ul>
          </div>
        </div>
        <div class="col-md-3 col-sm-6">
          <div class="footer-menu footer-menu-004 border-animation-left">
            ...
            <p>Do you need support? Give us a call. <a href="tel:+43720115278" class="item-anchor">+43 720 11 52 78</a></p>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-md-6 d-flex flex-wrap">
            <div class="shipping">
              ...
              <img src="{{ asset('assets/images/dhl-logo.png') }}" alt="icon" style="display: block !important; width: 120px !important; min-height: 50px !important; background-color: red !important; object-fit: contain;">
            </div>
