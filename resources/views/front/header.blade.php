    ...
    <div class="search-popup-container">
      ...
      <ul class="cat-list">
        <li class="cat-list-item">
          <a href="{{ asset('assets/style.css') }}#" title="Jackets">Jackets</a>
        </li>
        <li class="cat-list-item">
          <a href="{{ asset('assets/style.css') }}#" title="T-shirts">T-shirts</a>
        </li>
        <li class="cat-list-item">
          <a href="{{ asset('assets/style.css') }}#" title="Handbags">Handbags</a>
        </li>
        <li class="cat-list-item">
          <a href="{{ asset('assets/style.css') }}#" title="Accessories">Accessories</a>
        </li>
        <li class="cat-list-item">
          <a href="{{ asset('assets/style.css') }}#" title="Cosmetics">Cosmetics</a>
        </li>
        <li class="cat-list-item">
          <a href="{{ asset('assets/style.css') }}#" title="Dresses">Dresses</a>
        </li>
        <li class="cat-list-item">
          <a href="{{ asset('assets/style.css') }}#" title="Jumpsuits">Jumpsuits</a>
        </li>
      </ul>
      ...
      <div class="row justify-content-between align-items-center w-100">
          ...
          <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
            ...
            <div class="offcanvas-body">
              <ul class="navbar-nav justify-content-end flex-grow-1 gap-1 gap-md-5 pe-3">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="{{ asset('assets/style.css') }}/#">Blog</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="{{ asset('assets/style.css') }}/#">Contact</a>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div class="col-3 col-lg-auto">
          <ul class="list-unstyled d-flex m-0">
            ...
            <li class="d-lg-none">
              <a href="{{ asset('assets/style.css') }}/#" class="mx-2">
