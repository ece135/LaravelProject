...
<div class="container py-5">
    ...
    <div class="text-center mb-5 pt-4">
        <h1 class="display-4 text-uppercase" style="font-weight: 700; letter-spacing: 2px;">Contact Us</h1>
        <p class="text-muted text-uppercase" style="letter-spacing: 1px; font-size: 13px;">We'd love to hear from you</p>
    </div>

    <div class="row g-5 mb-5">
        <div class="col-md-5">
            <h4 class="text-uppercase mb-4" style="font-weight: 600; letter-spacing: 1px;">Get In Touch</h4>
            <p class="text-muted mb-4" style="line-height: 1.8;">Have a question about our products, your order, or just want to say hi? Drop us a message.</p>
            
            <div class="mb-3">
                <strong class="text-uppercase" style="font-size: 13px;">Address:</strong><br>
                <span class="text-muted">123 Fashion Avenue, Commerce Building, Suite 45, New York, NY 10001, USA</span>
            </div>
            <div class="mb-3">
                <strong class="text-uppercase" style="font-size: 13px;">Phone:</strong><br>
                <span class="text-muted">+1 234 567 8900</span>
            </div>
            <div class="mb-3">
                <strong class="text-uppercase" style="font-size: 13px;">Email:</strong><br>
                <span class="text-muted">info@fashionhub.com</span>
            </div>
        </div>
        ...
        <div class="col-md-7">
            <form action="#" method="POST">
                ...
                <div class="row g-3 mb-3">
                    <div class="col-sm-6">
                        <label class="form-label text-uppercase" style="font-size: 12px; font-weight: 600;">First Name</label>
                        <input type="text" class="form-control rounded-0 border-dark" placeholder="John" required>
                    </div>
                    <div class="col-sm-6">
                        <label class="form-label text-uppercase" style="font-size: 12px; font-weight: 600;">Last Name</label>
                        <input type="text" class="form-control rounded-0 border-dark" placeholder="Doe" required>
                    </div>
                </div>
                <div class="mb-3">
                    <label class="form-label text-uppercase" style="font-size: 12px; font-weight: 600;">Email Address</label>
                    <input type="email" class="form-control rounded-0 border-dark" placeholder="john@example.com" required>
                </div>
                <div class="mb-4">
                    <label class="form-label text-uppercase" style="font-size: 12px; font-weight: 600;">Message</label>
                    <textarea class="form-control rounded-0 border-dark" rows="5" placeholder="How can we help you?" required></textarea>
                </div>
                <button type="submit" class="btn btn-dark rounded-0 text-uppercase px-5 py-2 w-100" style="letter-spacing: 1px;">Send Message</button>
            </form>
        </div>
    </div>
</div>
